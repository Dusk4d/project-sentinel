...
public final class RuleCatalog {
    ...
    public static final String DOCS_README_UNVERIFIED = "docs.readme-unverified";
    ...
    public static final String BUILD_MANIFEST_UNVERIFIED = "build.manifest-unverified";
    ...
    public static final List<RuleDefinition> DEFINITIONS = List.of(
            ...
            new RuleDefinition(DOCS_README_UNVERIFIED, "文档", "README* 超过文本读取上限或读取失败，内容无法验证"),
            new RuleDefinition(BUILD_MANIFEST, "可复现性", "缺少可识别的构建清单"),
            new RuleDefinition(BUILD_MANIFEST_EMPTY, "可复现性", "存在受支持的构建清单但内容为空"),
            new RuleDefinition(BUILD_MANIFEST_UNVERIFIED, "可复现性", "构建清单超过文本读取上限或读取失败，内容无法验证"),
