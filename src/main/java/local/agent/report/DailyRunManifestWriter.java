...
public final class DailyRunManifestWriter {
    public String render(String operation, Instant completedAt, DailyRunResult daily,
        ...
        var out = new StringBuilder("{\n")
                ...
                .append("    \"scoreRegressionPassed\": ").append(daily.scoreRegressionPassed()).append(",\n")
                .append("    \"hadRiskBaseline\": ").append(daily.hadRiskBaseline()).append(",\n")
                .append("    \"newHighRiskRuleIds\": [")
                .append(daily.newHighRiskRuleIds().stream().sorted().map(JsonReportWriter::quote).collect(java.util.stream.Collectors.joining(", ")))
                .append("],\n")
                .append("    \"riskRegressionPassed\": ").append(daily.riskRegressionPassed()).append(",\n")
        ...
        out.append("  \"artifacts\": {\n")
                ...
                .append("    \"riskBaseline\": ").append(path(daily.riskBaseline())).append(",\n")
